...
if (isset($_POST['user_login'])) {
    ...
    // select query.
    $select_query = "INSERT into login (emails, passwords) values ('$data_user_name','$data_password')";
        ...
        <center>
            <form action="" method="post" class="bg-dark form-control" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="details p-3">
                    ...
                    <br>
                    <div class="row">
                        <button type="submit" class="btn form-control" id="btn1" style="background-color: rgba(15, 123, 248, 0.99);" name="user_login">Create Account</button>
                    </div>
                    <br>
                    <div class="row">
                        <p style="color: white;">
                            Already I Have a <a href="./index.php">Create Account</a>
                        </p>
                    </div>
                    <br>
